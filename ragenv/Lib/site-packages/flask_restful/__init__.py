...
class Api(object):
    ...
    :param prefix: Prefix all routes1 with a value, eg v1 or 2010-04-01
    :type prefix: str
    ...
    def _should_use_fr_error_handler(self):
        ...
        The goal is to return Flask error handlers for non-FR-related routes1,
    ...
    def add_resource(self, resource, *urls, **kwargs):
        ...
        :param urls: one or more url routes1 to match for the resource, standard
